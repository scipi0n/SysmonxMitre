...
class event_5:
    ...
    def write_file(self):
        #EVENTO 5
        with open('myapp/sysmon_events_rules/Event5.xml', 'r') as f:
            event = f.read()
        ...
        if conjunto:
            ...
            Bs_event.ProcessTerminate.extend(single_list)
            res = Bs_event.find_all('RuleGroup', {'name': '5_include'})
        ...
        if self.excludes == 1:
            rules_exclude = Bs_event.find_all('RuleGroup',{'name': '5_exclude'})
